    ...
    <section id="projects" className="py-16 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
         ...
         <div
  key={project.name}
  className="group bg-gray-800/60 backdrop-blur-lg rounded-2xl shadow-lg overflow-hidden hover:shadow-lime-500/30 transition-all duration-500 flex flex-col"
>
  {/* Project Image */}
  ...
  <div className="p-6 flex flex-col flex-1">
    ...
    <div className="flex gap-4 mt-auto">
      {project.website && (
        ...
        >
          <FaExternalLinkAlt /> <span>Visit Website</span>
        </a>
      )}
